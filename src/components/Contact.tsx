    ...
    <h2 className="text-5xl font-bold mb-12 text-center text-gradiant max-md:3xl">Contact</h2>
      <div className="flex flex-col gap-2">
        ...
        social.map((item, index) => (
          <div key={index} className="flex items-center justify-between gap-4 transition-color duration-300 ease-in-out hover:text-white cursor-pointer hover:scale-105 bg-white/10 p-4 rounded-lg">
